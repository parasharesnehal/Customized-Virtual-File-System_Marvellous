...
void CreateDILB()//DILB: Dynamic Inode Link List Block
{
    int i = 1;     //INODE should start from 1
    PINODE newn = NULL;
    PINODE temp = head;
...
int CreateFile(char *name, int permission)
{
    ...
    (SUPERBLOCKobj.FreeInode)--;      //decrement free inode count 


    while(temp != NULL) //to get empty inode
    {
...
// SHELL 
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            {
                system("cls"); //clear screen in windows (platform dependent)
                continue;
            }
